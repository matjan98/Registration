...
namespace Database.Migrations
{
    ...
    [Migration("20201025231947_AddWorkingTimeTable")]
    partial class AddWorkingTimeTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Database.Tables.DoctorWorkingTime", b =>
                {
                    b.Property<int>("FK_ID_User")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Database.Tables.DoctorWorkingTime", b =>
                {
                    b.HasOne("Database.Tables.User", "User")
                        .WithOne("DoctorWorkingTime")
                        .HasForeignKey("Database.Tables.DoctorWorkingTime", "FK_ID_User")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
